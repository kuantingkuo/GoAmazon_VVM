...
say    'set parea 'xp1' 'xp2' 'yp1' 'yp2
    ...
    j=j+1
endwhile
'gxprint /data/W.eddie/GoAmazon_VVM_Figs/Buo_cld_evo_3_'exp_tag'_'radi'km.png white'
'gxprint /data/W.eddie/GoAmazon_VVM_Figs/Buo_cld_evo_3_'exp_tag'_'radi'km.svg white'
