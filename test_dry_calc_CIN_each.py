...
#    q_new[-6] -= 0.002
    for k in range(-2,-9,-1):
        theta_e[k] = (theta_e[-1]*(k+9) + theta_e[-9]*(-1-k)) / 8.
    ...
    CIN.to_netcdf('test_dry2_Init_CIN_each.nc')
    W = xr.DataArray(
        w,
        name='W',
        dims=['pressure'],
    ...
    W.to_netcdf('test_dry2_W2CIN_each.nc')
    WI = xr.DataArray(
        wi,
        name='WI',
        dims=['pressure'],
    ...
    WI.to_netcdf('test_dry2_WI2CIN_each.nc')
