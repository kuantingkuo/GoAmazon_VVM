...
while(it<=tnum)
    ...
    while(i<=2)
        ...
        'Theta=amean(th.'i'*(1+0.608*qv.'i'),x=64,x=65,y=64,y=65)'
        'Tc=T-273.15'
    ...
    it=it+1
endwhile
'gxprint /data/W.eddie/GoAmazon_VVM_Figs/Fig8_thetaV.png white'
'gxprint /data/W.eddie/GoAmazon_VVM_Figs/Fig8_thetaV.svg white'
